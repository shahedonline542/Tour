...
export default function TimelineSection() {
  const timelineItems = [
    ...
    },
    {
      ...
      description: 'ধর্মপ্রাণ সদস্যদের নিভৃতে যোহরের নামায আদায়ের বিরতি। নামাজ শেষে আমাদের জন্য অপেক্ষারত থাকবে মার্কেটিং বিভাগের (২য় বর্ষ) সুস্বাদু ও আকর্ষণীয় দুপুরের খাবার।',
